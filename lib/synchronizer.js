...
require.scopes['synchronizer'] = (function() {
  ...
  var Synchronizer = exports.Synchronizer = {
     ...
     */
    execute: function(subscription, manual, callback) {
      downloader.download(this._getDownloadable(subscription, manual, callback));
    },
     ...
     * @return {Downloadable}
     */
    _getDownloadable: function(/**Subscription*/ subscription, /**Boolean*/ manual, callback) {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback) {
      ...
      if (downloadable.redirectURL && downloadable.redirectURL != downloadable.url) {
        ...
        Subscription.removeSubscription(oldSubscription.url);
      ...
      Subscription.updateSubscriptionFilters(subscription, filters);
      if (downloadable.callback)
        downloadable.callback();
    },
